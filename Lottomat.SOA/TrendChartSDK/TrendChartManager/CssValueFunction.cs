    ...
    public class CssValueFunction
    {
        ...
        public static string MultiValue_RepeatNumber<TEntity>(TEntity localEntity, TrendChartItemInfo itemConfig, bool isValue, string fomart, string attr, ChartCssConfigInfo css, string itemValue, int index) where TEntity : LotteryOpenCode
        {
            ...
            switch (itemConfig.Cid)
            {
                case 2:
                case 3: //P5
                    IList<QG_TCP3> TCP3lastList = TCP3Service.ToListForTrend(localEntity.Term, null);//获取前一期开奖数据
                    ...
                    IList<QG_TCP3> TCP3nextList = TCP3Service.ToListForNextTrend(localEntity.Term, null);
                    ...
                    return GetCssValue(isValue, fomart, attr, css, itemValue, index);
                case 4: //双色球
                    IList<QG_FCSSQ> FCSSQlastList = FCSSQService.ToListForTrend(localEntity.Term, null);//获取前一期开奖数据
                    ...
                    IList<QG_FCSSQ> FCSSQnextList = FCSSQService.ToListForNextTrend(localEntity.Term, null);
                    ...
                    break;
                case 5: //七乐彩
                    IList<QG_FCQLC> FCQLClastList = FCQLCService.ToListForTrend(localEntity.Term, null);//获取前一期开奖数据
                    ...
                    IList<QG_FCQLC> FCQLCnextList = FCQLCService.ToListForNextTrend(localEntity.Term, null);
                    ...
                    break;
                case 12: //大乐透
                    IList<QG_FCQLC> TCDLTlastList = TCDLTService.ToListForTrend(localEntity.Term, null);//获取前一期开奖数据
                    ...
                    IList<QG_FCQLC> TCDLTnextList = TCDLTService.ToListForNextTrend(localEntity.Term, null);
        ...
        public static string MultiValue_ZheHaoNumber<TEntity>(TEntity localEntity, TrendChartItemInfo itemConfig, bool isValue, string fomart, string attr, ChartCssConfigInfo css, string itemValue, int index) where TEntity : LotteryOpenCode
        {
            ...
            switch (itemConfig.Cid)
            {
                case 4:   //双色球
                    ...
                    break;
                case 12://大乐透
                    IList<QG_TCDLT> TCDLTlastList = TCDLTService.ToListForTrend(localEntity.Term, null);//获取前一期开奖数据
                    if (null != TCDLTlastList && TCDLTlastList[0].Term == localEntity.Term && TCDLTlastList.Count == 2)
                    {
                        lastOpenCode = LotteryUtils.GetOpenCodeList<TEntity>(TCDLTlastList[1] as TEntity, itemConfig.IndexStart, itemConfig.IndexEnd);
                    }
                    IList<QG_TCDLT> TCDLTnextList = TCDLTService.ToListForNextTrend(localEntity.Term, null);
                    if (null != TCDLTnextList && TCDLTnextList[0].Term == localEntity.Term && TCDLTnextList.Count == 2)//获取后一期开奖数据
                    {
                        nextOpenCode = LotteryUtils.GetOpenCodeList<TEntity>(TCDLTnextList[1] as TEntity, itemConfig.IndexStart, itemConfig.IndexEnd);
                    }
        ...
        public static string MultiValue_XieTiaoHaoNumber<TEntity>(TEntity localEntity, TrendChartItemInfo itemConfig, bool isValue, string fomart, string attr, ChartCssConfigInfo css, string itemValue, int index) where TEntity : LotteryOpenCode
        {
            ...
            switch (itemConfig.Cid)
            {
                case 4: //双色球
                    ...
                    {
                        lastOpenCode = LotteryUtils.GetOpenCodeList<TEntity>(FCSSQlastList[1] as TEntity, itemConfig.IndexStart, itemConfig.IndexEnd);
                        IList<QG_FCSSQ> FCSSQlastlastList = FCSSQService.ToListForTrend(FCSSQlastList[1].Term, null);//获取前一期开奖数据
                    ...
                    {
                        nextOpenCode = LotteryUtils.GetOpenCodeList<TEntity>(FCSSQnextList[1] as TEntity, itemConfig.IndexStart, itemConfig.IndexEnd);
                        IList<QG_FCSSQ> FCSSQnextnextList = FCSSQService.ToListForNextTrend(FCSSQnextList[1].Term, null);//获取前一期开奖数据
                ...
                case 12: //大乐透
                    ...
                    if (null != TCDLTlastList && TCDLTlastList[0].Term == localEntity.Term && TCDLTlastList.Count == 2)
                    {
                        ...
                        IList<QG_TCDLT> TCDLTlastlastList = TCDLTService.ToListForTrend(TCDLTlastList[1].Term, null);
                        //获取前一期开奖数据
                    ...
                    //获取后一期开奖数据
                    {
                        nextOpenCode = LotteryUtils.GetOpenCodeList<TEntity>(TCDLTnextList[1] as TEntity,
                            itemConfig.IndexStart, itemConfig.IndexEnd);
                        IList<QG_TCDLT> TCDLTnextnextList = TCDLTService.ToListForNextTrend(TCDLTnextList[1].Term, null);
                        //获取前一期开奖数据
        ...
        public static string MultiValue_ShuTiaoHaoNumber<TEntity>(TEntity localEntity, TrendChartItemInfo itemConfig, bool isValue, string fomart, string attr, ChartCssConfigInfo css, string itemValue, int index) where TEntity : LotteryOpenCode
        {
            ...
            switch (itemConfig.Cid)
            {
                case 12:   //大乐透
                    ...
                    {
                        lastOpenCode = LotteryUtils.GetOpenCodeList<TEntity>(TCDLTlastList[1] as TEntity, itemConfig.IndexStart, itemConfig.IndexEnd);
                        IList<QG_TCDLT> TCDLTlastlastList = TCDLTService.ToListForTrend(TCDLTlastList[1].Term, null);//获取前一期开奖数据
                    ...
                    {
                        nextOpenCode = LotteryUtils.GetOpenCodeList<TEntity>(TCDLTnextList[1] as TEntity, itemConfig.IndexStart, itemConfig.IndexEnd);
                        IList<QG_TCDLT> TCDLTnextnextList = TCDLTService.ToListForNextTrend(TCDLTnextList[1].Term, null);//获取前一期开奖数据
        ...
        /// <param name="index"></param>
        /// <returns></returns>
        private static string GetCssName(bool isValue, ChartCssConfigInfo css, int index)
        {
            if (css != null) //有样式
            {
                if (css.ChildList == null)//没有子样式 
        ...
        public static string SingleValue_HeWei012Item(bool isValue, string fomart, string attr, ChartCssConfigInfo css, string itemValue, int index)
        {
            return GetCssValue(isValue, fomart, attr, css, itemValue, index);
        }

        public static string SingleValue_MaxItem(bool isValue, string fomart, string attr, ChartCssConfigInfo css, string itemValue, int index)
        {
            return GetCssValue(isValue, fomart, attr, css, itemValue, index);
        }

        public static string SingleValue_MinItem(bool isValue, string fomart, string attr, ChartCssConfigInfo css, string itemValue, int index)
        {
            return GetCssValue(isValue, fomart, attr, css, itemValue, index);
        }

        public static string SingleValue_AvgItem(bool isValue, string fomart, string attr, ChartCssConfigInfo css, string itemValue, int index)
        {
            return GetCssValue(isValue, fomart, attr, css, itemValue, index);
        }

        public static string SingleValue_HkhItem(bool isValue, string fomart, string attr, ChartCssConfigInfo css, string itemValue, int index)
        {
            return GetCssValue(isValue, fomart, attr, css, itemValue, index);
        }

        public static string SingleValue_HkcItem(bool isValue, string fomart, string attr, ChartCssConfigInfo css, string itemValue, int index)
        {
            return GetCssValue(isValue, fomart, attr, css, itemValue, index);
        }

        public static string SingleValue_WhzItem(bool isValue, string fomart, string attr, ChartCssConfigInfo css, string itemValue, int index)
        {
            return GetCssValue(isValue, fomart, attr, css, itemValue, index);
        }
    }
