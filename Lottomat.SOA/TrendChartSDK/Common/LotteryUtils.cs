...
namespace TrendChartSDK.Common
{
    ...
    public class LotteryUtils
    {
        ...
        /// <param name="lottery"></param>
        /// <returns></returns>
        public static List<dynamic> GetLotteryDDLQi2(int topSize, long latestQi, string lottery)
        {
           var objCodeList = new List<dynamic>();
            dynamic objsCode = new System.Dynamic.ExpandoObject();
            //var objNumberList = new List<dynamic>();
        ...
        /// 获取中奖数字
        /// </summary>
        /// <param name="arr1">开奖号</param>
        /// <param name="arr2">对比号</param>
        /// <returns></returns>
