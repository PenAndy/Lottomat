...
namespace Lottomat.SOA.API.Controllers.V1
{
    ...
    /// 高频彩快乐10分
    /// </summary>
    public class GPCKL10FController : BaseApiController
    {
        /// <summary>
        /// 公共BLL
        /// </summary>
        ...
        #region 获取高频彩快乐10分彩种历史记录
        /// <summary>
        /// 获取高频彩快乐10分彩种历史记录
        /// </summary>
        /// <returns></returns>
        [HttpPost]
        public HttpResponseMessage GetGPCKL10FHistoryLotteryList(HistoryLotteryArgEnyity arg)
        {
            BaseJson<string> resultMsg = new BaseJson<string> { Status = (int)JsonObjectStatus.Error, Message = "服务器未知错误。", Data = null };

            Logger(typeof(GPCKL10FController), arg.TryToJson(), "获取高频彩快乐10分彩种历史记录-GetGPCKL10FHistoryLotteryList", () =>
            {
        ...
        private string GetResultByEnumCode(SCCLottery type, HistoryLotteryArgEnyity arg)
        {
            ...
            switch (type)
            {
                case SCCLottery.TianJinKL10F:
                    res = AppendCommonResult(data, SCCLottery.TianJinKL10F);
                    break;
                default:
        ...
        {
            List<GPCKL10FHistoryLotteryViewEntity> res = new List<GPCKL10FHistoryLotteryViewEntity>();
            if (data.Rows.Count > 0)
            {
                ...
                for (int j = 0; j < data.Rows.Count; j++)
                {
                    ...
                    res.Add(new GPCKL10FHistoryLotteryViewEntity
                    {
                        ...
                        TheSum = LotteryUtils.GetTheSum(openCodeList, 55, GetSumNumberCount(type)),
                        Size = LotteryUtils.GetDXString(openCodeList, 10),
