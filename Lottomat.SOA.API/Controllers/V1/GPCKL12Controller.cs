...
namespace Lottomat.SOA.API.Controllers.V1
{
    ...
    /// 高频彩快乐12
    /// </summary>
    public class GPCKL12Controller : BaseApiController
    {
        /// <summary>
        /// 公共BLL
        /// </summary>
        ...
        #region 获取高频彩快乐12彩种历史记录
        /// <summary>
        /// 获取高频彩快乐12彩种历史记录
        /// </summary>
        /// <returns></returns>
        [HttpPost]
        public HttpResponseMessage GetGPCKL12HistoryLotteryList(HistoryLotteryArgEnyity arg)
        {
            BaseJson<string> resultMsg = new BaseJson<string> { Status = (int)JsonObjectStatus.Error, Message = "服务器未知错误。", Data = null };

            Logger(typeof(GPCKL12Controller), arg.TryToJson(), "获取高频彩快乐12彩种历史记录-GetGPCKL12HistoryLotteryList", () =>
            {
        ...
        private string GetResultByEnumCode(SCCLottery type, HistoryLotteryArgEnyity arg)
        {
            ...
            switch (type)
            {
                case SCCLottery.ZheJiangKL12:
                    res = AppendCommonResult(data, SCCLottery.ZheJiangKL12);
                    break;
                default:
        ...
        {
            List<GPCKL12HistoryLotteryViewEntity> res = new List<GPCKL12HistoryLotteryViewEntity>();
            if (data.Rows.Count > 0)
            {
                ...
                for (int j = 0; j < data.Rows.Count; j++)
                {
                    ...
                    res.Add(new GPCKL12HistoryLotteryViewEntity
                    {
                        ...
                        SizeRatio = LotteryUtils.GetProportionOfDX(openCodeList, 5),
