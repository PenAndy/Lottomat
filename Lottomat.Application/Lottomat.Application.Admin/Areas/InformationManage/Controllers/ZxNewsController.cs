...
namespace Lottomat.Application.Admin.Areas.InformationManage.Controllers
{
    ...
    /// 描 述：55128资讯内容
    /// </summary>
    public class ZxNewsController : MvcControllerBase
    {
        private ZxNewsBLL newsbll = new ZxNewsBLL();
        ...
        {
            var data = newsbll.GetList(queryJson);
        ...
        [ValidateAntiForgeryToken]
        [AjaxOnly]
        public ActionResult SaveForm(string keyValue, ZxNewsEntity entity)
        {
            newsbll.SaveForm(keyValue, entity);
            return Success("操作成功。");
        }
        #endregion
    }
