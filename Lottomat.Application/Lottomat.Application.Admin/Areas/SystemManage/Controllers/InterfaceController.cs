...
namespace Lottomat.Application.Admin.Areas.SystemManage.Controllers
{
    ...
    {
        private InterfaceBLL interfacebll = new InterfaceBLL();
        ...
        public ActionResult GetPageListJson(Pagination pagination, string queryJson)
        {
            ...
            var data = interfacebll.GetPageList(pagination, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var data = interfacebll.GetList(queryJson);
        ...
        {
            var data = interfacebll.GetEntity(keyValue);
            return ToJsonResult(data);
        }
        #endregion
        ...
        {
            interfacebll.RemoveForm(keyValue);
            return Success("删除成功。");
        }
        /// <summary>
        /// 保存表单（新增、修改）
