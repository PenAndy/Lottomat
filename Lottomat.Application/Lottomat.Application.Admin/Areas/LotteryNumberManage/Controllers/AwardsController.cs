...
namespace Lottomat.Application.Admin.Areas.LotteryNumberManage.Controllers
{
    ...
    /// 描 述：彩票规则
    /// </summary>
    public class AwardsController : MvcControllerBase
    {
        private AwardsBLL awardsbll = new AwardsBLL();
        ...
        public ActionResult GetPageListJson(Pagination pagination, string queryJson)
        {
            ...
            var data = awardsbll.GetPageList(pagination, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var data = awardsbll.GetList(queryJson);
        ...
        {
            var data = awardsbll.GetEntity(keyValue);
            return ToJsonResult(data);
        }
        #endregion
