...
namespace Lottomat.Application.Admin
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //Lottomat
            bundles.Add(new StyleBundle("~/Content/styles/txwl-ui.css").Include(
                        "~/Content/styles/txwl-ui.css"));
            bundles.Add(new ScriptBundle("~/Content/scripts/utils/js").Include(
                       "~/Content/scripts/utils/txwl-ui.js",
                       "~/Content/scripts/utils/txwl-form.js"));
            //Lottomat Order
            ...
            //工作流
            bundles.Add(new StyleBundle("~/Content/styles/txwl-flowall.css").Include(
            "~/Content/styles/txwl-ckbox-radio.css",
            "~/Content/styles/txwl-applayout.css",
            "~/Content/styles/txwl-flow.css"));
            bundles.Add(new ScriptBundle("~/Content/scripts/flow/js").Include(
              "~/Content/scripts/utils/txwl-applayout.js",
              "~/Content/scripts/plugins/flow-ui/flow.js",
              "~/Content/scripts/utils/txwl-flowlayout.js"));
        }
    }
}