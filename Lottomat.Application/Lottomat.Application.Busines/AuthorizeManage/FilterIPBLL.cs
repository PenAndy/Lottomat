    ...
    public class FilterIPBLL
    {
        ...
        public bool FilterIP()
        {
            ...
            if (black_cacheList == null)
            {
                ...
                CacheFactory.Cache().WriteCache(blackIPList, black_cacheKey, DateTimeHelper.Now.AddMinutes(1));
            }
            else
            {
            ...
            if (white_cacheList == null)
            {
                ...
                CacheFactory.Cache().WriteCache(whiteIPList, black_cacheKey, DateTimeHelper.Now.AddMinutes(1));
            }
            else
            {
