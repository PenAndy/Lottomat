...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-辽宁35选7
    /// </summary>
    public class DF35x7LiaoNingService : RepositoryFactory<DF35x7LiaoNingEntity>, IDF35x7LiaoNingService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        {
            var expression = LinqExtensions.True<DF35x7LiaoNingEntity>();
