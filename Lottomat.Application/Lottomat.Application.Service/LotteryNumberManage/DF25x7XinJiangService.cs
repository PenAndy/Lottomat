...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-新疆25选7
    /// </summary>
    public class DF25x7XinJiangService : RepositoryFactory<DF25x7XinJiangEntity>, IDF25x7XinJiangService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<DF25x7XinJiangEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<DF25x7XinJiangEntity>();
        ...
        public IEnumerable<DF25x7XinJiangEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public DF25x7XinJiangEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, DF25x7XinJiangEntity entity,string isCheck)
        {
