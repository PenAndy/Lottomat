...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-黑龙江36选7
    /// </summary>
    public class DF36x7HeiLongJiangService : RepositoryFactory<DF36x7HeiLongJiangEntity>, IDF36x7HeiLongJiangService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<DF36x7HeiLongJiangEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<DF36x7HeiLongJiangEntity>();
        ...
        public IEnumerable<DF36x7HeiLongJiangEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public DF36x7HeiLongJiangEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, DF36x7HeiLongJiangEntity entity,string isCheck)
        {
