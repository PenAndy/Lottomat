...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-河北排列7
    /// </summary>
    public class DFPL7HeBeiService : RepositoryFactory<DFPL7HeBeiEntity>, IDFPL7HeBeiService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<DFPL7HeBeiEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<DFPL7HeBeiEntity>();
        ...
        public IEnumerable<DFPL7HeBeiEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public DFPL7HeBeiEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, DFPL7HeBeiEntity entity,string isCheck)
        {
