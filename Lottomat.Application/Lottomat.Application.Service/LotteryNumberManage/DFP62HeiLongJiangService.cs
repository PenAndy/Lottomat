...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-黑龙江P62
    /// </summary>
    public class DFP62HeiLongJiangService : RepositoryFactory<DFP62HeiLongJiangEntity>, IDFP62HeiLongJiangService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<DFP62HeiLongJiangEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<DFP62HeiLongJiangEntity>();
        ...
        public IEnumerable<DFP62HeiLongJiangEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public DFP62HeiLongJiangEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, DFP62HeiLongJiangEntity entity,string isCheck)
        {
