...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：高频彩-北京11选5
    /// </summary>
    public class GP11x5BeiJingService : RepositoryFactory<GP11x5BeiJingEntity>, IGP11x5BeiJingService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<GP11x5BeiJingEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<GP11x5BeiJingEntity>();
        ...
        public IEnumerable<GP11x5BeiJingEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public GP11x5BeiJingEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, GP11x5BeiJingEntity entity)
        {
