...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-浙江20选5
    /// </summary>
    public class DF20x5ZheJiangService : RepositoryFactory<DF20x5ZheJiangEntity>, IDF20x5ZheJiangService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        {
            var expression = LinqExtensions.True<DF20x5ZheJiangEntity>();
