...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：全国彩-大乐透
    /// </summary>
    public class QGTCDLTService : RepositoryFactory<QGTCDLTEntity>, IQGTCDLTService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<QGTCDLTEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<QGTCDLTEntity>();
        ...
        public IEnumerable<QGTCDLTEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public QGTCDLTEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, QGTCDLTEntity entity,string isCheck)
        {
