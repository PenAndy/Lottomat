...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-香港六合彩
    /// </summary>
    public class DFSMHLHCHongKongService : RepositoryFactory<DFSMHLHCHongKongEntity>, IDFSMHLHCHongKongService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<DFSMHLHCHongKongEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<DFSMHLHCHongKongEntity>();
        ...
        public IEnumerable<DFSMHLHCHongKongEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public DFSMHLHCHongKongEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, DFSMHLHCHongKongEntity entity,string isCheck)
        {
