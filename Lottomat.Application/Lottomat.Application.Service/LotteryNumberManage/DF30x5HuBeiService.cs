...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-湖北30选5
    /// </summary>
    public class DF30x5HuBeiService : RepositoryFactory<DF30x5HuBeiEntity>, IDF30x5HuBeiService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<DF30x5HuBeiEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<DF30x5HuBeiEntity>();
        ...
        public IEnumerable<DF30x5HuBeiEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public DF30x5HuBeiEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, DF30x5HuBeiEntity entity,string isCheck)
        {
