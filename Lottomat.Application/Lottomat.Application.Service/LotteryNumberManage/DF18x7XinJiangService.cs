...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-新疆18选7
    /// </summary>
    public class DF18x7XinJiangService : RepositoryFactory<DF18x7XinJiangEntity>, IDF18x7XinJiangService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<DF18x7XinJiangEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<DF18x7XinJiangEntity>();
        ...
        public IEnumerable<DF18x7XinJiangEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public DF18x7XinJiangEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, DF18x7XinJiangEntity entity,string isCheck)
        {
