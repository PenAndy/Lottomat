...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-福建体彩22选5
    /// </summary>
    public class DFTC22x5FuJianService : RepositoryFactory<DFTC22x5FuJianEntity>, IDFTC22x5FuJianService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<DFTC22x5FuJianEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<DFTC22x5FuJianEntity>();
        ...
        public IEnumerable<DFTC22x5FuJianEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public DFTC22x5FuJianEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, DFTC22x5FuJianEntity entity,string isCheck)
        {
