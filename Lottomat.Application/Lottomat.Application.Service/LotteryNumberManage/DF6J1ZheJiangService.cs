...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-浙江6+1
    /// </summary>
    public class DF6J1ZheJiangService : RepositoryFactory<DF6J1ZheJiangEntity>, IDF6J1ZheJiangService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<DF6J1ZheJiangEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<DF6J1ZheJiangEntity>();
        ...
        public IEnumerable<DF6J1ZheJiangEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public DF6J1ZheJiangEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, DF6J1ZheJiangEntity entity,string isCheck)
        {
