...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：全国彩-双色球
    /// </summary>
    public class QGFCSSQService : RepositoryFactory<QGFCSSQEntity>, IQGFCSSQService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<QGFCSSQEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<QGFCSSQEntity>();
        ...
        public IEnumerable<QGFCSSQEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public QGFCSSQEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, QGFCSSQEntity entity,string isCheck)
        {
