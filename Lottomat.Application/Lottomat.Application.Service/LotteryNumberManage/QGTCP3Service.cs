...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：全国彩-排列三、排列五
    /// </summary>
    public class QGTCP3Service : RepositoryFactory<QGTCP3Entity>, IQGTCP3Service
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<QGTCP3Entity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<QGTCP3Entity>();
        ...
        public IEnumerable<QGTCP3Entity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public QGTCP3Entity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, QGTCP3Entity entity,string isCheck)
        {
