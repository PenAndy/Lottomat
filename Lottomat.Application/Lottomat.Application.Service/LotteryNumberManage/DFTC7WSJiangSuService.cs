...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-江苏7位数
    /// </summary>
    public class DFTC7WSJiangSuService : RepositoryFactory<DFTC7WSJiangSuEntity>, IDFTC7WSJiangSuService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        {
            var expression = LinqExtensions.True<DFTC7WSJiangSuEntity>();
