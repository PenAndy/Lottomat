...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-河北好运彩3
    /// </summary>
    public class DFHYC3HeBeiService : RepositoryFactory<DFHYC3HeBeiEntity>, IDFHYC3HeBeiService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<DFHYC3HeBeiEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<DFHYC3HeBeiEntity>();
        ...
        public IEnumerable<DFHYC3HeBeiEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public DFHYC3HeBeiEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, DFHYC3HeBeiEntity entity,string isCheck)
        {
