...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-广东36选7
    /// </summary>
    public class DF36x7GuangDongService : RepositoryFactory<DF36x7GuangDongEntity>, IDF36x7GuangDongService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        {
            var expression = LinqExtensions.True<DF36x7GuangDongEntity>();
