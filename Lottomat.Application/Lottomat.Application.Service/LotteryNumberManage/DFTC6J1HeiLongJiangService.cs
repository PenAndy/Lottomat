...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-黑龙江体彩6+1
    /// </summary>
    public class DFTC6J1HeiLongJiangService : RepositoryFactory<DFTC6J1HeiLongJiangEntity>, IDFTC6J1HeiLongJiangService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<DFTC6J1HeiLongJiangEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<DFTC6J1HeiLongJiangEntity>();
        ...
        public IEnumerable<DFTC6J1HeiLongJiangEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public DFTC6J1HeiLongJiangEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, DFTC6J1HeiLongJiangEntity entity,string isCheck)
        {
