...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-河北20选5
    /// </summary>
    public class DF20x5HeBeiService : RepositoryFactory<DF20x5HeBeiEntity>, IDF20x5HeBeiService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<DF20x5HeBeiEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<DF20x5HeBeiEntity>();
        ...
        public IEnumerable<DF20x5HeBeiEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public DF20x5HeBeiEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, DF20x5HeBeiEntity entity,string isCheck)
        {
