...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：地方彩-广东深圳风采35选7
    /// </summary>
    public class DFSZFCGuangDongService : RepositoryFactory<DFSZFCGuangDongEntity>, IDFSZFCGuangDongService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<DFSZFCGuangDongEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<DFSZFCGuangDongEntity>();
        ...
        public IEnumerable<DFSZFCGuangDongEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public DFSZFCGuangDongEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, DFSZFCGuangDongEntity entity,string isCheck)
        {
