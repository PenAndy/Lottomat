...
namespace Lottomat.Application.Service.LotteryNumberManage
{
    ...
    /// 描 述：全国彩-七乐彩
    /// </summary>
    public class QGFCQLCService : RepositoryFactory<QGFCQLCEntity>, IQGFCQLCService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<QGFCQLCEntity> GetPageList(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<QGFCQLCEntity>();
        ...
        public IEnumerable<QGFCQLCEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public QGFCQLCEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, QGFCQLCEntity entity,string isCheck)
        {
