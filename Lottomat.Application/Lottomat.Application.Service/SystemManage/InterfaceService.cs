...
namespace Lottomat.Application.Service.SystemManage
{
    ...
    /// 描 述：系统API接口
    /// </summary>
    public class InterfaceService : RepositoryFactory<InterfaceEntity>, IInterfaceService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<InterfaceEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<InterfaceEntity> GetList(string queryJson)
        {
