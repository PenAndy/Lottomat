...
namespace Lottomat.Utils
{
    ...
    public class LotteryUtils
    {
        ...
        /// <param name="isCheckDX">是否检查大小</param>
        /// <returns></returns>
        public static string GetTheSum(IList<int> list, int splitNumber, int count = 0, bool isCheckDX = true)
        {
            StringBuilder sb = new StringBuilder();
            int total = GetSum(list, count);

            sb.Append(total.ToString() + "|");
            sb.Append(IsJoNumbers(total) ? "单|" : "双|");
            if (isCheckDX)
                sb.Append(total == splitNumber ? "和|" : total > splitNumber ? "大|" : "小|");

            return StringHelper.DelLastChar(sb.ToString(), "|");
        }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static string GetTheSum(IList<int> list)
        {
            StringBuilder sb = new StringBuilder();
            int total = 0;
        ...
        /// <param name="splitNumber"></param>
        /// <returns></returns>
        public static string GetTheSumByK3(IList<int> list, int splitNumber)
        {
            StringBuilder sb = new StringBuilder();
            int total = 0;
            foreach (int i in list)
            ...
            sb.Append(total == 15 ? "通吃|" : total > splitNumber ? "大|" : "小|");
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static string GetJOString(IList<int> list, string showOText = "偶", string showJText = "奇")
        {
            StringBuilder sb = new StringBuilder();
        ...
        /// <param name="openCode"></param>
        /// <returns></returns>
        public static string GetZodiacByOpenCode(int openCode)
        {
            var res = "";
            switch (openCode)
            {
        ...
        /// <param name="openCode"></param>
        /// <returns></returns>
        public static string GetSeasonByOpenCode(int openCode)
        {
            var res = "";
            switch (openCode)
            {
        ...
        /// <param name="openCode"></param>
        /// <returns></returns>
        public static string GetPositionByOpenCode(int openCode)
        {
            var res = "";
            switch (openCode)
            {
