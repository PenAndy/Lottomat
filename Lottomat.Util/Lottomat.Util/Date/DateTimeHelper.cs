...
namespace Lottomat.Utils.Date
{
    ...
    public class DateTimeHelper
    {
        ...
        {
            return DateTimeHelper.Now.ToString("yyyy-MM-dd");
        }
        /// <summary>
        /// 当前日期自定义格式
        /// </summary>
        ...
        {
            return DateTimeHelper.Now.ToString(format);
        }
        /// <summary>
        /// 当前日期 加添加，减天数 -1、1
        /// </summary>
        ...
        {
            DateTime dt = DateTimeHelper.Now;
            dt = dt.AddDays(i);
