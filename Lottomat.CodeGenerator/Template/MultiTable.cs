    ...
    public class MultiTable
    {
        ...
        public string EntityBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> gridColumnModel, bool isChildTable)
        {
            ...
            try
            {
                ...
                sb.Append("namespace Lottomat.Application.Entity." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
                ...
                foreach (var item in gridColumnModel)
                {
                    ...
                    {
                        strCreateDate = "this.CreateDate = DateTimeHelper.Now;\r\n";
                    }
                    ...
                    {
                        strModifyDate = "this.ModifyDate = DateTimeHelper.Now;\r\n";
                    }
                ...
                if (isChildTable)
                {
                    sb.Append("            this." + multiTableConfigModel.ChildTablePk + " = CommonHelper.GetGuid().ToString();\r\n");
                }
                else
                {
                    sb.Append("            this." + multiTableConfigModel.DataBaseTablePK + " = CommonHelper.GetGuid().ToString();\r\n");
                }
        ...
        public string EntityMapBuilder(MultiTableConfigModel multiTableConfigModel, bool isChildTable)
        {
            try
            {
                ...
                StringBuilder sb = new StringBuilder();
                sb.Append("using Lottomat.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
                sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

                sb.Append("namespace Lottomat.Application.Mapping." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
                sb.Append("    /// Copyright (c) 2016-2017\r\n");
        ...
        /// <param name="multiTableConfigModel"></param>
        /// <returns></returns>
        public string ServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Lottomat.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Lottomat.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            ...
            sb.Append("namespace Lottomat.Application.Service." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.0\r\n");
            sb.Append("    /// Copyright (c) 2016-2017\r\n");
            ...
            sb.Append("                db.Delete<" + multiTableConfigModel.ChildTableName + "Entity>(t => t.F_OrderId.Equals(keyValue));\r\n");
            sb.Append("                db.Commit();\r\n");
            sb.Append("            }\r\n");
        ...
        public string IServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("namespace Lottomat.Application.IService." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.0\r\n");
            sb.Append("    /// Copyright (c) 2016-2017\r\n");
        ...
        public string BusinesBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("using Lottomat.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Lottomat.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Lottomat.Application.Service." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Lottomat.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace Lottomat.Application.Busines." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.0\r\n");
            sb.Append("    /// Copyright (c) 2016-2017\r\n");
        ...
        public string ControllerBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Lottomat.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Lottomat.Application.Busines." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Lottomat.Util;\r\n");
            sb.Append("using Lottomat.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace Lottomat.Application.Admin.Areas." + multiTableConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.0\r\n");
            sb.Append("    /// Copyright (c) 2016-2017\r\n");
            ...
            sb.Append("            var childData = client_orderbll.GetDetails(keyValue);");
            sb.Append("            var jsonData = new");
            sb.Append("            {");
            ...
            sb.Append("            " + multiTableConfigModel.BusinesClassName.ToLower() + ".SaveForm(keyValue, entity, entryList);\r\n");
        ...
        {
            var areasUrl = multiTableConfigModel.OutputAreas + "/" + StringHelper.DelLastLength(multiTableConfigModel.ControllerName, 10);
            StringBuilder sb = new StringBuilder();
            sb.Append("@{;\r\n");
